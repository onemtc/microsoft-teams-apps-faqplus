...
namespace Microsoft.Teams.Apps.FAQPlusPlus.Common.Providers
{
    ...
    public interface IQnaServiceProvider
    {
        ...
        Task<QnASearchResultList> GenerateAnswerAsync(string question, bool isTestKnowledgeBase, string userId = null, string previousQnAId = null, string previousUserQuery = null);
